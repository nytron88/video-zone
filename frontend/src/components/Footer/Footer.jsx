...
const Footer = () => {
  return (
    <footer className="bg-black text-gray-300 py-12 mt-auto relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative">
        <div className="flex flex-col items-center justify-center space-y-6">
          ...
          <div className="relative">
            ...
            <div className="h-px w-full bg-gradient-to-r from-transparent via-gray-700 to-transparent mt-2"></div>
          </div>

          {/* Creator Credit */}
          <p className="text-sm">
            Crafted with passion by{" "}
            <span className="bg-gradient-to-r from-violet-400 to-cyan-400 bg-clip-text text-transparent font-medium hover:from-violet-300 hover:to-cyan-300 transition-all duration-300 cursor-pointer">
              Siddhant Jain
            </span>
          </p>
          ...
          <div className="text-sm text-gray-600">
            © {new Date().getFullYear()} Video Zone. All rights reserved.
          </div>
        </div>
      </div>
    </footer>
